...
<body bgcolor="#11998e">
<br><br>
<h3>Tambah Data Jadwal Mata Pelajaran</h3><br>

<div>
  <form method="post" action="proses_jadwal.php?action=add">
	...
	<label>Jam</label>
    <select name="jam"><option value="jam">--- Dari jam ---</option><?php echo get_times(); ?></select>
	<select name="jam2"><option value="jam2">--- Sampai jam ---</option><?php echo get_times(); ?></select>
