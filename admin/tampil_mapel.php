...
<body bgcolor="#11998e">
	...
	<a href="tambah_mapel.php">Tambah Mata Pelajaran</a>
	<br><br>
	<table border="1">
		<tr >
		...
		foreach($data_mapel as $row){
			...
			<tr>
				...
				<td style="text-align: center">
					<a href="edit_mapel.php?id_mapel=<?php echo $row['id_mapel']; ?>">Ubah</a>
					<a href="proses_mapel.php?action=delete&id_mapel=<?php echo $row['id_mapel']; ?>">Hapus</a>
				</td>
			</tr>
			<?php 
		}
